---
date: 2021-05-15T17:12
date created: Sunday, April 6th 2025, 10:03:23 pm
date modified: Sunday, April 6th 2025, 10:03:43 pm
excerpt: For the last few months I have been using Roam Research as the
link: https://gregmorris.co.uk/2021/05/15/my-obsidian-set.html
slurped: 2025-04-06T22:03
title: Greg Morris - My Obsidian Set Up
---

# Greg Morris - My Obsidian Set Up

For the last few months I have been using Roam Research as the powerhouse behind almost everything I do. I’ve written previously of my love for the way it allows me to record my thoughts and everything that goes on in my life. It links very heavily in to both my [writing workflow](https://gregmorris.co.uk/2020/08/21/my-writing-workflow.html) and my [reading workflow](https://gregmorris.co.uk/2020/08/22/my-reading-flow.html), and as such has been a huge boost to my working and personal life.

Even with all this praise, I have still always looked for something else. Although it has proved valuable, I don’t love the £195 a year price tag, and I also hate it is only semi available on mobile, and has no offline mode. I’ve tried alternatives, including [Obsidian](https://obsidian.md/), but nothing else quite fit the bill, but this time something stuck and I’d like to share my current Obsidian set up, what it does for me and how it could help you.
...
This is a huge benefit when you consider that access to something as important as your network of thoughts should be available at all times. I have not experienced issues accessing Roam, but other online apps *have* [had these issues](https://www.reddit.com/r/Notion/comments/evnryg/notion_is_not_loading_site_and_desktop_app/). Also consider that I _have_lost work because Roam has updated itself and not saved my document — and I am [not alone](https://www.reddit.com/r/RoamResearch/comments/gdbq77/how_common_is_data_loss/) with these issues, as rare as they are.
...
You can also install plugins outside of the app that are easy to discover in their [thriving community](https://obsidian.md/community) or their Discord channel. From my experience most people don’t stray outside of the Community plug ins. I use the following heavily.  
– [Calendar](https://github.com/liamcain/obsidian-calendar-plugin): This shows a calendar in the right side bar, allowing you to go back to daily notes from those days or make daily notes on dates in the future.  
– [Natural Language Dates](https://github.com/argenos/nldates-obsidian): This allows you to easily tag things with dates by using `@today`or `@tomorrow` or even `@next week`.  
– [Text Expander](https://github.com/konodyuk/obsidian-text-expander): Does exactly what it says on the tin. Allowing you to customise short codes and replace them with regularly used bit of text.  
– [Kindle Highlights](https://github.com/hadynz/obsidian-kindle-plugin): Syncs by book highlights into my book notes folder in a similar fashion to Readwise.
...
Wait, there are plugins though! After using [Obsidian GTD](https://github.com/larslockefeer/obsidian-plugin-todo) for a little while I opted to use [Tasks](https://github.com/schemar/obsidian-tasks). The benefit of this was that I can get my set up to display the tasks I have to complete in a way that works for me. I have a note titled tasks that contains code to display my priorities that are overdue, need doing today and those that are upcoming. As well as having an Inbox of sorts by surfacing any task I have not allocated a date to.
...
I tried this also with Podcast notes, which can be really useful when sycnced through the app [Airr](https://www.airr.io/). However since my [listening declined](https://gregmorris.co.uk/2021/05/12/my-podcast-feed.html) these have stopped completely.
...
Using the very geeky commandline universal converting service [Pandoc](https://pandoc.org/) and the [accompanying plugin](https://github.com/OliverBalfour/obsidian-pandoc), I can also export my work documents and things I am working on to docx and pdf as and when required. I don’t really want to get in to setting this up because it is boring, but I might do at some point.
